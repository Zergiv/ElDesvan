...
[GitHub Releases](https://github.com/Zergiv/ElDesvan/releases)

| Plataforma | Archivo |
| -------- | ---- |
| Windows | `ElDesvan-setup-VERSION.exe` |
| macOS | `ElDesvan-setup-VERSION-*.dmg` |
| Linux | `ElDesvan-setup-VERSION.AppImage` |

## Desarrollo

Node.js v22 + [pnpm](https://pnpm.io/)
